...
_app.factory('RandomDataModel', function ($interval, WidgetDataModel) {
...
_app.factory('MyChartDataModel', function (WidgetDataModel) {
   function MyChartDataModel() {
   }

   MyChartDataModel.prototype = Object.create(WidgetDataModel.prototype);
   MyChartDataModel.prototype.constructor = WidgetDataModel;

   angular.extend(MyChartDataModel.prototype, {
      init: function () {
         var dataModelOptions = this.dataModelOptions;
         // this.limit = (dataModelOptions && dataModelOptions.limit) ? dataModelOptions.limit : 100;
